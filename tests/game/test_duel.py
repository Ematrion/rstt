...
def test_opponent_player1(p1_versus_p2):
    assert p1_versus_p2.opponent(p1_versus_p2.player1()) == p1_versus_p2.player2()
...
def test_played_not_live(p1_versus_p2, result):
    ...
    assert p1_versus_p2.live() == False
...
def test_no_draw(p1_beats_p2, p2_loses_p1):
